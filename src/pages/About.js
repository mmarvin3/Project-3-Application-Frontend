...
<h1> About the Developers</h1>
 ...
 <div className="candace">
    ...
    <p>Lorem</p> 
    <a href="https://www.linkedin.com/in/candace-pinero-84a6b922b/" target="_blank" rel="noreferrer">
        <button><ion-icon name="logo-linkedin" size="large"></ion-icon></button>
    </a>
    <a href="https://github.com/candacepinero" target="_blank" rel="noreferrer">
        <button><ion-icon name="logo-github" size="large"></ion-icon></button>
    </a>
</div> 
    <div className="david">
    <h2> David Barbour</h2>
